    ...
    <div class="main-sidemenu">
            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    @if(!empty(auth()->user()->image))
                        <img alt="user-img" class="avatar avatar-xl brround" src="{{asset('image/'.auth()->user()->image)}}"><span class="avatar-status profile-status bg-green"></span>
                    @else
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{route('all.user')}}">All User</a></li>
                </ul>
            </li>
        </ul>
        @endif
